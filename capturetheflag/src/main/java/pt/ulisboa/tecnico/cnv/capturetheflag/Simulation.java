...
public class Simulation {
  ...
  public void init(
      int gridSize,
      char flagPlacementType,
      int numBlueAgents,
      int numRedAgents,
      int numFlagsPerTeam,
      boolean coloredOutput) {
    sb.append("[DEBUG] grid_size = ")
        .append(gridSize)
        .append("; flag_placement_type = ")
        .append(flagPlacementType)
        .append("\n");
    sb.append("[DEBUG] num_blue_agents = ")
        .append(numBlueAgents)
        .append("; num_red_agents = ")
        .append(numRedAgents)
        .append("\n");
    sb.append("\n");
    ...
    grid.spawnObstacles();
    grid.spawnFlags(
        flagPlacementType, this.redFlagPositions, this.blueFlagPositions, numFlagsPerTeam);
  ...
  public void run() {
    ...
    sb.append("[INFO] round = ")
        .append(round)
        .append("; score (blue, red) = (")
        .append(blueScore)
        .append(", ")
        .append(redScore)
        .append(")\n");
    ...
    sb.append("[INFO] final score (blue, red) = (")
        .append(blueScore)
        .append(", ")
        .append(redScore)
        .append(")\n");
  ...
  public int[] bfsNextStep(int sx, int sy, int tx, int ty) {
      ...
      for (int[] dir : DIRECTIONS) {
        ...
        if (this.grid.inBounds(nx, ny) && !visited[nx][ny]) {
          ...
          if (this.grid.cellHasFlag(nx, ny) && (nx != tx || ny != ty)
              ...
              || this.grid.cellHasObstacle(nx, ny)) continue;
    ...
    if (!visited[tx][ty]) return null; // no path found
