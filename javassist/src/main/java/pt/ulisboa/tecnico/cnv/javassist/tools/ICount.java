...
public class ICount extends CodeDumper {
  ...
  /** Returns the number of executed basic blocks by thread and resets counter for next requests */
  ...
  /** Returns the number of executed methods by thread and resets counter for next requests */
  ...
  /** Returns the number of executed instructions by thread and resets counter for next requests */
  ...
  public static void printStatistics() {
    ...
    System.out.println(
        String.format(
            "[%s] Thread: %s Number of executed methods: %s",
            ICount.class.getSimpleName(), Thread.currentThread().getId(), nmethods.get(threadId)));
    System.out.println(
        String.format(
            "[%s] Thread: %s Number of executed basic blocks: %s",
            ICount.class.getSimpleName(), nblocks.get(threadId)));
    System.out.println(
        String.format(
            "[%s] Thread: %s Number of executed instructions: %s",
            ICount.class.getSimpleName(), ninsts.get(threadId)));
  }

  /**
   * Shows the metrics corresponding to the application metrics in String format to store on a file
  ...
  protected void transform(CtBehavior behavior) throws Exception {
    ...
    behavior.insertAfter(
        String.format("%s.incBehavior(\"%s\");", ICount.class.getName(), behavior.getLongName()));
