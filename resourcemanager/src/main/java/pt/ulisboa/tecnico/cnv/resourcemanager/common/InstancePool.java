...
public class InstancePool {
  ...
  public Instance selectInstanceForRequest() {
    ...
    // Simple load balancing - select instance with fewest pending jobs
    return runningInstances.stream()
        .min(Comparator.comparingInt(Instance::getPendingJobs))
        .orElse(null);
  }
